...
export function UsersPage() {
  ...
  return (
    <div className={styles["devices-container"]}>
      ...
      <Modal isOpen={showAddModal} onClose={closeAddModal} title="Add User">
      ...
      <Modal isOpen={showDeleteModal} onClose={closeDeleteModal} title="Delete User">
        <div className={styles["dashboard-modal-form"]}>
          <p>Are you sure you want to delete <strong>{selectedUser?.email || "this user"}</strong>? This action cannot be undone.</p>
          {actionError && <p className={styles["dashboard-modal-error"]}>{actionError}</p>}
          <div className={styles["dashboard-modal-actions"]}>
